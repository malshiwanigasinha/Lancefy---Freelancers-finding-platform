        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-5xl font-semibold lg:text-8xl !leading-tight"
            >
              Find Your Perfect <span className="text-primary">Freelancer</span>
            </motion.h1>
            <motion.p
              ...
              animate="visible"
            >
              We help you find the perfect freelancer for your project needs. It's completely free and secure
            </motion.p>
            {/* button section */}
            <motion.div
            ...
            >
              <button className="primary-btn">Find a Freelancer</button>
